...
class EchoService_Stub : public EchoService {
 public:
  ...
  void Echo(::google::protobuf::RpcController* controller,
                       ...
                       ::echo::EchoResponse* response,
                       ::google::protobuf::Closure* done);
  void EchoTunnelMsg(::google::protobuf::RpcController* controller,
                       const ::echo::EmptyMessage* request,
                       ::Arab::TunnelMsg* response,
                       ::google::protobuf::Closure* done);
 private:
...
inline void EchoResponse::set_has_error() {
  _has_bits_[0] |= 0x00000001u;
}
inline void EchoResponse::clear_has_error() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline const ::Arab::ErrorCode& EchoResponse::error() const {
  return error_ != NULL ? *error_ : *default_instance_->error_;
}
inline ::Arab::ErrorCode* EchoResponse::mutable_error() {
  set_has_error();
  if (error_ == NULL) error_ = new ::Arab::ErrorCode;
  return error_;
}
inline ::Arab::ErrorCode* EchoResponse::release_error() {
  clear_has_error();
